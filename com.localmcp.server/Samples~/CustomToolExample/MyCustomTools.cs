...
namespace CustomToolExample
{
    ...
    public static class MyCustomTools
    {
        ...
        /// </summary>
        [LocalMCP.MCPTool("my_echo", "Echo a message back - example custom tool")]
        [LocalMCP.MCPParam("message", "string", "Message to echo back")]
        ...
        /// </summary>
        [LocalMCP.MCPTool("list_tags", "List all tags defined in the Unity project")]
        ...
        /// </summary>
        [LocalMCP.MCPTool("list_layers", "List all layers defined in the Unity project")]
        ...
        /// </summary>
        [LocalMCP.MCPTool("project_info", "Get basic project information")]
